    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row mx-2 mb-3">
                <div class="mb-3">
                    <h3 class="head-title mb-2">Stock</h3>
                    <button type="button" class="tb-button py-2 px-4 my-2" data-bs-toggle="modal" data-bs-target="#addstok">
                        <span><i class="fa-solid fa-plus me-2"></i></span>New Stock
                    </button>
                </div>
                        ...
                        <table id="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $stok['tanggal_restock']; ?></td>
                                    <td><?php echo $stok['status']; ?></td>
                                    <td class="text-center">
    									<a class="btn btn-edit me-2" data-bs-toggle="modal" data-bs-target="#editstok<?php echo $stok['kode_bahan'];?>"><i class="fa-solid fa-edit"></i></a>
    									<a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapusStok<?php echo $stok['kode_bahan'];?>"><i class="fa-solid fa-trash"></i></a>
    								</td>
                                </tr>
                            
                                <div class="modal fade" id="editstok<?php echo $stok['kode_bahan'];?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content" style="border: none; border-radius: 20px;">
                                            ...
                                            <div class="modal-body">
                                                <form id="menuForm" method="POST" action="process/stok/update_data.php">
                                                    <div class="">
                                                        <input type="text" name="kode_bahan" value="<?php echo $stok['kode_bahan']; ?>" hidden>
                                                    </div>
                                                                                
                                                    <div class="mb-3">
                                                        <label for="name" class="form-label">Name</label>
                                                        <input type="text" name="nama" class="form-control" value="<?php echo $stok['nama']; ?>" id="name" required>
                                                    </div>
                                                                  
                                                    <div class="mb-3">
                                                        <label for="phone" class="form-label">Quantity</label>
                                                        <input type="int" name="jumlah" class="form-control" value="<?php echo $stok['jumlah']; ?>" id="phone" required>
                                                    </div>
                                                                                
                                                    <div class="mb-3">
                                                        <label for="password" class="form-label">Price</label>
                                                        <input type="number" name="harga" class="form-control" value="<?php echo $stok['harga']; ?>" id="password" required>
                                                    </div>
                                                                                
                                                    <div class="mb-3">
                                                        <label for="email" class="form-label">Restock Date</label>
                                                        <input type="date" name="tanggal_restock" class="form-control" value="<?php echo $stok['tanggal_restock']; ?>" id="email" required>
                                                    </div>

                                                    <div class="mb-3">
                                                        <label for="category" class="form-label">Status</label>
                                                        <input type="text" name="status" class="form-control" value="<?php echo $stok['status']; ?>" id="name" required>
                                                    </div>
                                ...
                                <div class="modal fade" id="hapusStok<?php echo $stok['kode_bahan'];?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" enctype="multipart/form-data">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content" style="border: none; border-radius: 20px;">
                                            <div class="modal-header justify-content-center">
                                                <h5 class="d-block modal-title">Delete Stock</h5>
                                            </div>
                                                                        
                                            <div class="modal-body">
                                                <form id="menuForm" method="POST" action="process/stok/delete_data.php?kode_bahan=<?php echo $stok['kode_bahan']; ?>">
                                                    <div class="">
                                                        <input type="text" name="kode_bahan" hidden>
                                                    </div>
                                                                                
                                                    <div class="text-center mb-3">
                                                        <h4>Delete <span class="fw-bold"><?php echo $stok['nama'];?></span> permanently?</h4>
                                                    </div>
        ...
        <div class="modal fade" id="addstok" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content" style="border: none; border-radius: 20px;">
                    ...
                    <div class="modal-body">
                        <form id="menuForm" method="POST" action="process/stok/insert_data.php">
                            <div class="">
                                <input type="text" name="kode_bahan" hidden>
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="phone" class="form-label">Quantity</label>
                                <input type="int" name="jumlah" class="form-control" id="phone" required>
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="email" class="form-label">Restock Date</label>
                                <input type="date" name="tanggal_restock" class="form-control" id="email" required>
                            </div>

                            <div class="mb-3">
                                <label for="category" class="form-label">Status</label>
                                <input type="text" name="status" class="form-control" id="name" required>
                            </div>
        ...
        <nav class="navbar navbar-expand-lg fixed-bottom">
            <div class="container-fluid justify-content-center mb-3">
                <ul class="navbar-nav navbar-bottom">
                    ...
                    <li class="nav-item text-center mx-4">
                        <a class="nav-link d-grid py-0 active" href="stock.php"><i class="fa-solid fa-boxes-stacked mb-2"></i>Stock</a>
                    </li>
                    <li class="nav-item text-center mx-4">
